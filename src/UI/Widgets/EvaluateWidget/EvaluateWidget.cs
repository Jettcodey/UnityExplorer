...
namespace UnityExplorer.UI.Widgets
{
    public class EvaluateWidget : IPooledObject
    {
        ...
        public GameObject CreateContent(GameObject parent)
        {
            ...
            Text genericsTitle = UIFactory.CreateLabel(genericArgumentsHolder, "GenericsTitle", TranslationManager.Get(TranslationKey.GenericArguments), TextAnchor.MiddleLeft);
            ...
            Text argsTitle = UIFactory.CreateLabel(parametersHolder, "ArgsTitle", TranslationManager.Get(TranslationKey.Arguments), TextAnchor.MiddleLeft);
            ...
            // evaluate button
            ButtonRef evalButton = UIFactory.CreateButton(UIRoot, "EvaluateButton", TranslationManager.Get(TranslationKey.Evaluate), new Color(0.2f, 0.2f, 0.2f));
