...
namespace UnityExplorer.ObjectExplorer
{
    public class ObjectSearch : UIModel
    {
        ...
        public override void ConstructUI(GameObject parent)
        {
            ...
            Text contextLbl = UIFactory.CreateLabel(contextGroup, "SearchContextLabel", TranslationManager.Get(TranslationKey.SearchingFor), TextAnchor.MiddleLeft);
            ...
            Text unityClassLbl = UIFactory.CreateLabel(classInputRow, "ClassLabel", TranslationManager.Get(TranslationKey.ClassFilter), TextAnchor.MiddleLeft);
            ...
            Text childLbl = UIFactory.CreateLabel(childFilterRow, "ChildLabel", TranslationManager.Get(TranslationKey.ChildFilter), TextAnchor.MiddleLeft);
            ...
            Text sceneLbl = UIFactory.CreateLabel(sceneFilterRow, "SceneLabel", TranslationManager.Get(TranslationKey.SceneFilter), TextAnchor.MiddleLeft);
            ...
            Text nameLbl = UIFactory.CreateLabel(nameInputRow, "NameFilterLabel", TranslationManager.Get(TranslationKey.NameContains), TextAnchor.MiddleLeft);
            ...
            ButtonRef searchButton = UIFactory.CreateButton(uiRoot, "SearchButton", TranslationManager.Get(TranslationKey.Search));
            ...
            resultsLabel = UIFactory.CreateLabel(resultsCountRow, "ResultsLabel", TranslationManager.Get(TranslationKey.ResultsCount, 0), TextAnchor.MiddleCenter);
